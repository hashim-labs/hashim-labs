...
export default function Contact() {
	...
	return (
		<section id="contact" className="relative px-5 py-20 sm:px-8 lg:px-12">
			<div className="mx-auto max-w-7xl">
				...
				<div className="grid overflow-hidden rounded-2xl border border-white/10 bg-slate-950/70 lg:grid-cols-[0.85fr_1.15fr]">
					<div className="flex flex-col justify-between bg-gradient-to-br from-cyan-400/15 via-slate-950/20 to-emerald-400/10 p-7 sm:p-10">
						<div>
					...
					<motion.form onSubmit={handleSubmit} initial={{ opacity: 0, y: 12 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="p-7 sm:p-10">
